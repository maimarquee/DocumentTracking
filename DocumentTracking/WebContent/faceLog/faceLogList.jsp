...
<%
	...
	Pagination pagination = (Pagination)session.getAttribute(FaceLogDTO.SESSION_FACE_LOG_PAGINATION);
...
<div class="dataTables_wrapper form-inline dt-bootstrap col-md-12">
	...
	<%=WebUtil.getTableByCode(sessionInfo, "table table-bordered table-striped table-hover dataTable", "table table-bordered table-striped dataTable", FaceLogUtil.getTableHeader(), OfficeUtil.getTableBody(list), "gradeX", "") %>
