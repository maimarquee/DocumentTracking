...
function openUploadLink(linkCode) {
	document.getElementById("txtSelectedLink").value = linkCode;
	showDialogLoading();
	document.getElementById("frmMain").action = "UploadController";
	document.getElementById("frmMain").enctype="multipart/form-data";
	document.getElementById("frmMain").encoding="multipart/form-data";
	document.getElementById("frmMain").submit();
}
...
function showSubElementAboveMainElement(mainElementId, subElementId, e) {
	document.getElementById(mainElementId).style.background = "#F2F39E";
	document.getElementById(mainElementId).style.color = "#01243B";
	showFormElement(subElementId);
	document.getElementById(subElementId).style.left = (getCurrentCursorPosition(e)[0] - 100) + "px";
	document.getElementById(subElementId).style.top = (getCurrentCursorPosition(e)[1] + 10) + "px";
}
...
function displayPage(pageNum) {
	document.getElementById("txtPageNum").value = pageNum;
	openLink("9904");
}
